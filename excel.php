...
foreach($mtNames as $mtName)
{
	...
	$realData[] = array($_GET["customerId"], $mtName, $sozlesmesayi, $iptalsozlesmesayi, $gorusmesayi, $randevusayi, $satism2, $iptalSatism2, 
		$satisFiyat, $iptalSatisFiyat, $indirimTutar);
	
}
//var_dump($realData);
$arrHeader = array("Firma ID", "User ID", "Sözleşme Sayı", "İptal Edilen Sözleşme Sayı", "Görüşme Sayı", "Randevu Sayı", "Satış (m2)",
